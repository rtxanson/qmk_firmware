 ...
 *   TODO: first line left: = 
 *   TODO: fourth line left: need <> by Z/Ctrl
 *   TODO: fourth line right: -_ instead of //Ctrl ? 
 *   TODO: fifth line right: up down  ?? ? ?
 *
 *   missing keyse so far: ¨^  § 
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   =    |   1  |   2  |   3  |   4  |   5  | LEFT |           | RIGHT|   6  |   7  |   8  |   9  |   0  |   +    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Del    |   Q  |   W  |   E  |   R  |   T  |  L1  |           |  L1  |   Y  |   U  |   I  |   O  |   P  |   '    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | CTRL/Es|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |ö / L2| LGui/ä |
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
